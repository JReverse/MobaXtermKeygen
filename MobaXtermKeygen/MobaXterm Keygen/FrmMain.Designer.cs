...
namespace MobaXterm_Keygen
{
    partial class FrmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.minorVersion.Value = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            this.users.Maximum = new decimal(new int[] {
            99,
            0,
            0,
            0});
            this.users.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            this.users.Value = new decimal(new int[] {
            1,
            0,
            0,
            0});
            ...
            this.Name = "FrmMain";
            this.Text = "MobaXterm Keygen by JReverse";
